...
static function acesso()
       ...
       local x_opcao_001 := x_opcao_002 := x_opcao_003 := x_opcao_004 := .F.
       local x_opcao_005 := x_opcao_006 := x_opcao_007 := x_opcao_008 := .F.
       local x_opcao_009 := x_opcao_010 := x_opcao_011 := x_opcao_012 := .F.
       local x_opcao_013 := x_opcao_014 := x_opcao_015 := x_opcao_016 := .F.
       local x_opcao_017 := x_opcao_018 := x_opcao_019 := x_opcao_020 := .F.
       local x_opcao_021 := x_opcao_022 := x_opcao_023 := x_opcao_024 := .F.
       local x_opcao_025 := x_opcao_026 := x_opcao_027 := x_opcao_028 := .F.
       local x_opcao_029 := x_opcao_030 := x_opcao_031 := x_opcao_032 := .F.
       local x_opcao_033 := x_opcao_034 := x_opcao_035 := x_opcao_036 := .F.
       local x_opcao_037 := x_opcao_038 := x_opcao_039 := x_opcao_040 := .F.
       local x_opcao_041 := x_opcao_042 := x_opcao_043 := .F.
       local x_tipo := 1
