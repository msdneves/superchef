...
function venderbalcao()
		 ...
		 *pack
         ...
         define window form_vender;
                ...
                modal;
                nosize;
                on init ( zera_tabelas_balcao(), desabilita_campos_balcao() )
                /*
...
*                		  notabstop
                ...
                */
                @ 045,860 buttonex botao_cadastra_produto;
                          ...
                          action cadastrar_novo_produto_balcao();
                          font 'courier new' size 10;
                          bold;
                		  notabstop;
                ...
                */
			    @ 140,750 label label_borda;
     		    ...
     		    define comboboxex cbo_bordas
			           ...
			           fontsize 12
			           fontcolor BLUE
			           on gotfocus verifica_campo_vazio_balcao(1)
         	    end comboboxex
         	    /*
         	      quantidade
         	    */
                ...
                */
                @ 255,890 buttonex botao_gravar_pizza;
                          ...
                          action fecha_montagem_pizza_balcao();
                ...
                * escolher código do produto
                ...
                @ 330,210 textbox tbox_produto;
                          ...
                          backcolor _fundo_get;
                          fontcolor _letra_get_1;
                          on enter procura_produto_balcao()
                ...
                * quantidade
			    @ 310,780 label label_quantidade_2;
		  		...
		  		@ 330,780 spinner sp_quantidade_2;
						  ...
						  font 'courier new' size 12;
						  bold;
						  on gotfocus verifica_campo_vazio_balcao(2)
                /*
                  botão grava produto
                */
                @ 320,890 buttonex botao_gravar_produto;
                          ...
                          width 120 height 40;
                          picture path_imagens+'img_gravar.bmp';
                          action transfere_produto_pedido_balcao();
                		  font 'courier new' size 12 bold;
                		  backcolor {217,217,255}
				*--------------------------------*
				*                                *
				...
				*--------------------------------*
                @ 450,890 buttonex botao_excluir;
                          ...
                          action excluir_item_pedido_balcao();
                		  notabstop;
                		  font 'courier new' size 10 bold;
                		  fontcolor RED
                @ 495,890 buttonex botao_cupom;
                          ...
                          action emitir_comanda_balcao(_id_venda);
                		  notabstop;
                		  font 'courier new' size 10 bold
                @ 625,890 buttonex botao_sair;
                          ...
                          action desabilita_botao_voltar_balcao();
                		  notabstop;
                		  font 'courier new' size 10 bold

              	on key escape action pergunta_saida_balcao()
...
*-------------------------------------------------------------------------------
static function pergunta_saida_balcao()
	   ...
	   if form_vender.tbox_produto.enabled == .F.
	      ...
	      desabilita_botao_voltar_balcao()
	   endif

	   return(nil)
*-------------------------------------------------------------------------------
static function procura_produto_balcao()
       ...
       if found() .and. !produtos->pizza
     	  ...
     	  mostra_listagem_produto_balcao()
       endif

       return(nil)
*-------------------------------------------------------------------------------
static function mostra_listagem_produto_balcao()
       ...
       define window form_pesquisa;
              ...
              define textbox txt_pesquisa
                     ...
                     width 470
                     maxlength 40
                     onchange find_descricao_balcao()
                     uppercase .T.
              end textbox
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function find_descricao_balcao()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function mostra_informacao_produto_balcao()
...
static function procura_pizza(p_numero)
       ...
       if found() .and. produtos->pizza
          ...
          elseif p_numero == 4
     	  ...
     	  mostra_listagem_pizza_balcao(p_numero)
       endif
       
       return(nil)
*-------------------------------------------------------------------------------
static function mostra_listagem_pizza_balcao(p_numero)
       ...
       define window form_pesquisa;
              ...
              define grid grid_pesquisa
                     ...
                     backcolor WHITE
                     fontcolor BLUE
                     ondblclick mostra_informacao_balcao(p_numero)
              end grid
			  ...
			  @ 552,001 textbox tbox_pesquisa;
                    	...
                    	font 'verdana' size 010;
                     	backcolor _fundo_get;
                      	fontcolor _letra_get_1;
                       	uppercase;
              		  	on change pesquisar_pizza_balcao()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function popula_pizza_balcao()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function pesquisar_pizza_balcao()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function mostra_informacao_balcao(p_numero)
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function zera_tabelas_balcao()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function cadastrar_novo_produto_balcao()
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function gravar_produto_balcao()
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function excluir_pizza_balcao()
/*
...
*/
	    return(nil)
*-------------------------------------------------------------------------------
static function excluir_produto_balcao()
/*
...
*/
	    return(nil)
*-------------------------------------------------------------------------------
static function fecha_pizza_balcao()
/*
       dbselectarea('tmp_pizza')
       tmp_pizza->(dbgotop())
       if eof()
...
*/
       return(nil)
*-------------------------------------------------------------------------------
static function monta_informacao_pizza_balcao()
/*
       dbselectarea('tmp_pizza')
       tmp_pizza->(dbgotop())
...
*/
       return(nil)
*-------------------------------------------------------------------------------
static function pega_tamanho_valor_pizza_balcao()
/*
...
*/
       return(nil)
*-------------------------------------------------------------------------------
static function fecha_pedido_balcao()
       ...
       */
       define window form_fecha_pedido;
              ...
              * 3º
              ...
              @ 310,300 getbox tbox_fr003;
                        ...
                        fontcolor _letra_get_1;
                        picture '@E 99,999.99';
                        on lostfocus calcula_final_balcao(x_preco)
              ...
              */
              @ 460,005 buttonex botao_cupom;
                        ...
                        action imprimir_cupom_balcao(v_id,x_valor_pizza,x_valor_prod,form_fecha_pedido.tbox_desconto.value,v_nome_operacao);
              ...
              @ 460,165 buttonex botao_ok;
                        ...
                        action fechamento_geral_balcao(v_soma_compra,x_tipo_venda,v_id,p_codigo);
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function calcula_final_balcao(p_borda)
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function fechamento_geral_balcao(p_cliente,p_soma,p_tipo,p_id_geral,p_codigo)
	   ...
	   *
	   ...
	   mostra_info_grid_balcao(p_tipo)
...
*/
       ...
       * fechar janela
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function historico_cliente_balcao(parametro)
       return(nil)
*-------------------------------------------------------------------------------
static function mostra_detalhamento_balcao()
       return(nil)
*-------------------------------------------------------------------------------
static function pega_tamanho_balcao()
	   ...
	   *form_vender.grid_pizzas.setfocus
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function adiciona_montagem_balcao()
	   return(nil)
*-------------------------------------------------------------------------------
static function transfere_produto_pedido_balcao()
	   ...
	   */
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function excluir_sabor_balcao()
	   Return(Nil)
*-------------------------------------------------------------------------------
static function excluir_item_pedido_balcao()
	   ...
	   */
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function fecha_montagem_pizza_balcao()

	   local v_tipo_venda    := 2
	   ...
	   */
		  ...
		  if v_valor_borda <> 0
	   	  ...
	   	  *--------------------------*
	         dbselectarea('balcao')
       	  	 ...
       	  	 if found()
             	if lock_reg()
                   balcao->total := balcao->total + (x_valor_cobrado*v_qtd_pizza) + v_valor_borda
                   balcao->(dbunlock())
                   balcao->(dbcommit())
                endif
       	     endif
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function mostra_venda_balcao(p_parametro)
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function imprimir_cupom_balcao(p_id,p_vlr_pizza,p_vlr_prod,p_desconto,p_nome_operacao)
       ...
       *End
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function adiciona_borda_balcao()
	   return(nil)
*-------------------------------------------------------------------------------
static function emitir_comanda_balcao(p_parametro)

       local x_nome, x_fixo, x_endereco, x_numero
	   local x_tipo_venda       := 2
...
static function seleciona_tipo_de_venda()
       ...
       mostra_info_grid_balcao(2)
       setproperty('form_vender','grid_generico_balcao','enabled',.T.)
       setproperty('form_vender','botao_abre_','enabled',.T.)
       setproperty('form_vender','botao_consumo','enabled',.T.)
       setproperty('form_vender','botao_fecha_','enabled',.T.)
	   
	   return(nil)
*-------------------------------------------------------------------------------
static function habilita_campos_balcao()

       setproperty('form_vender','botao_cadastra_produto_balcao','enabled',.T.)
       ...
       setproperty('form_vender','label_pizza_balcao','enabled',.T.)
       ...
       setproperty('form_vender','botao_gravar_pizza_balcao','enabled',.T.)
       ...
       setproperty('form_vender','botao_gravar_produto_balcao','enabled',.T.)
       ...
       setproperty('form_vender','botao_excluir_balcao','enabled',.T.)
       setproperty('form_vender','botao_cupom_','enabled',.T.)
       setproperty('form_vender','botao_sair_','enabled',.T.)
       
	   form_vender.tbox_nome_balcao.setfocus
	   
	   return(nil)
*-------------------------------------------------------------------------------
static function mostra_info_grid_balcao(p_parametro)
	   ...
	   */
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function desabilita_campos_balcao()
...
static function abrir_balcao()
	   ...
	   mostra_info_grid_balcao(p_parametro)
	   desabilita_botoes_balcao(p_parametro)
	   
       return(nil)
*-------------------------------------------------------------------------------
static function consumir_balcao()
...
*	   return(nil)
**-------------------------------------------------------------------------------
static function desabilita_botao_voltar_balcao()

	   limpa_campos_balcao()
	   habilita_botoes_balcao()
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function limpa_campos_balcao()
...
static function limpar_balcao()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function verifica_campo_vazio_balcao(p_parametro)
...
static function desabilita_botoes_balcao(p_parametro)
...
static function habilita_botoes_balcao(p_parametro)
