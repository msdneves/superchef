         ...
         define window form_produtos;
                ...
                * botões (toolbar)
                ...
                define grid grid_produtos
                       ...
                       headers {'Código','Nome (longo)','Qtd.Estoque','Val.Pro/Esf','Grande.','Media.','Broto','Esfiha.'}
                       widths {060,400,120,120,120,120,120,120}
                       fontname 'verdana'
                       fontsize 010
                       fontbold .F.
...
static function dados(parametro)
       ...
       if parametro == 1
          titulo := 'Incluir'
       elseif parametro == 2
          id     := valor_coluna('grid_produtos','form_produtos',1)
          titulo := 'Alterar'
          dbselectarea('produtos')
...
static function compor_produto()
       ...
       local x_codigo_produto := valor_coluna('grid_produtos','form_produtos',1)
       local x_nome_produto   := valor_coluna('grid_produtos','form_produtos',2)
...
static function excluir()
       ...
       local id := valor_coluna('grid_produtos','form_produtos',1)
...
static function pesquisar()
       ...
       while .not. eof()
             if substr(field->nome_longo,1,nTamNomePesq) == cPesq
                add item {alltrim(produtos->codigo),alltrim(produtos->nome_longo),str(produtos->qtd_estoq,6),trans(produtos->vlr_venda,'@E 999.99'),trans(produtos->val_tm_001,'@E 999.99'),trans(produtos->val_tm_002,'@E 999.99'),trans(produtos->val_tm_003,'@E 999.99'),trans(produtos->val_tm_004,'@E 999.99')} to grid_produtos of form_produtos
...
static function atualizar()
       ...
       while .not. eof()
             add item {alltrim(produtos->codigo),alltrim(produtos->nome_longo),str(produtos->qtd_estoq,6),trans(produtos->vlr_venda,'@E 999.99'),trans(produtos->val_tm_001,'@E 999.99'),trans(produtos->val_tm_002,'@E 999.99'),trans(produtos->val_tm_003,'@E 999.99'),trans(produtos->val_tm_004,'@E 999.99')} to grid_produtos of form_produtos
*             add item {alltrim(produtos->codigo),alltrim(produtos->nome_longo),str(produtos->qtd_estoq,6)} to grid_produtos of form_produtos
             produtos->(dbskip())
       end

       return(nil)
*-------------------------------------------------------------------------------
function procura_categoria(cform,ctextbtn)
...
static function find_categoria_produtos()
       ...
       return(nil)
*-------------------------------------------------------------------------------
function procura_subcategoria(cform,ctextbtn)
...
static function find_subcategoria_produtos()
       ...
       return(nil)
*-------------------------------------------------------------------------------
function procura_imposto(cform,ctextbtn)
