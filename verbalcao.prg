...
function venderdelivery()
        ...
        define window form_vender;
                ...
                modal;
                nosize;
                on init ( zera_tabelas_delivery(), desabilita_campos_delivery() )
...
*                		  notabstop
				...
				*--------------------------------*
                ...
                @ 495,890 buttonex botao_cupom;
                          ...
                          action emitir_comanda(_id_venda);
                		  notabstop;
                		  font 'courier new' size 10 bold
       ...
       define window form_fecha_pedido;
              ...
              */
              @ 460,005 buttonex botao_cupom;
                        ...
                        action imprimir_cupom_delivery(v_id,x_valor_pizza,x_valor_prod,form_fecha_pedido.tbox_desconto.value,x_percentual_mesa,x_valor_taxa_entrega,x_ponto_referencia,x_observacoes,v_nome_operacao);
...
*/
       ...
       * fechar janela
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function historico_cliente_delivery(parametro)
       return(nil)
*-------------------------------------------------------------------------------
static function mostra_detalhamento_delivery()
       return(nil)
*-------------------------------------------------------------------------------
...
static function mostra_venda_delivery(p_parametro)
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function imprimir_cupom_delivery(p_id,p_vlr_pizza,p_vlr_prod,p_desconto,p_perc_mesa,p_taxa_entrega,p_ponto_ref,p_obs,p_nome_operacao)
