...
function vender()
		 ...
		 public x_tipo_parametro :=0
		 public y_ncaixa
		 public x_total :=0
    	 public xcomposicao1 :=1
    	 public xcomposicao2 :=1
    	 public xcomposicao3 :=1
    	 public xcomposicao4 :=1
         ...
         private _preco_antes_cobertura := 0
         public _tamanho_selecionado
         public _numero_tamanho  := 1
         public xvalcomposicao
		 ...
		 go top
		 while .not. eof()
		       if .not. empty(coberturas->nome)
		       	  aadd(a_coberturas,coberturas->nome+'-'+trans(coberturas->preco,'@E 999.99'))
		       	  aadd(a_nome_cobertura,coberturas->nome)
		       	  aadd(a_valor_cobertura,coberturas->preco)
		       endif
			   skip
		 end
		 ...
		 *pack
         ...
         define window form_vender;
                ...
                modal;
                nosize;
                on init ( zera_tabelas(), desabilita_campos() )
                /*
                ...
                */
                ...
                @ 045,005 buttonex botao_delivery;
                          parent form_vender;
                          caption 'F3'+CRLF+'Delivery';
                          width 190 height 40;
                          picture path_imagens+'menu_delivery.bmp';
				          	action seleciona_delivery(form_vender.botao_delivery.value);
                          font 'courier new' size 10;
                          bold;
                		  notabstop
		        @ 090,005 buttonex botao_balcao;
                          parent form_vender;
                          caption 'F5'+CRLF+'Balcão';
                          width 190 height 40;
                          picture path_imagens+'img_balcao.bmp';
                          action seleciona_balcao();
                          font 'courier new' size 10;
                          bold;
                		  notabstop
                @ 135,005 buttonex botao_mesa;
                          parent form_vender;
                          caption 'F4'+CRLF+'Mesa';
                          width 190 height 40;
                          picture path_imagens+'cadastrar_cliente.bmp';
                          action seleciona_mesa();
                          font 'courier new' size 10;
                          bold;
                		  notabstop
 				...
 				/*
				  escolhe : delivery - balcão - mesas
				*/
*       			@ 045,010 radiogroup radio_tipo_venda;
*                  		  options {'Delivery','Balcão','Mesa'};
*                 		  value 0;
*                 		  width 130;
*                 		  font 'courier new' size 14;
*                 		  bold;
*                 		  fontcolor BLUE;
*                 		  on change seleciona_tipo_de_venda();
*                 		  leftjustify
				/*
				  grid
				*/
                 ...
                 @ 180,005 grid grid_generico;
                          ...
                          widths {1,1,80,45,80};
                          on dblclick consumir(x_tipo_parametro);
                          font 'verdana' size 7;
                          backcolor WHITE;
                          fontcolor BLUE
                /*
                ...
                */
                @ 490,005 buttonex botao_abre;
                          parent form_vender;
                          caption 'F6'+CRLF+'ABRIR';
                          width 190 height 40;
                          picture path_imagens+'img_abre_mesa.bmp';
                          action abrir(x_tipo_parametro);
                          font 'courier new' size 10;
                          bold;
                		  notabstop
                @ 535,005 buttonex botao_consumo;
                          parent form_vender;
                          caption 'F7'+CRLF+'LIMPAR';
                          width 190 height 40;
                          picture path_imagens+'img_limpa_mesa.bmp';
                          action limpar(x_tipo_parametro);
                          font 'courier new' size 10;
                          bold;
                		  notabstop
                @ 580,005 buttonex botao_fecha;
                          parent form_vender;
                          caption 'F8'+CRLF+'FECHAR';
                          width 190 height 40;
                          picture path_imagens+'img_fecha_mesa.bmp';
                          action fecha_pedido(x_tipo_parametro);
                          font 'courier new' size 10;
                          bold;
                		  notabstop
...
*                		  notabstop
                @ 625,005 buttonex botao_sair_tela;
                          parent form_vender;
                          caption 'F9'+CRLF+'SAIR';
                          width 190 height 40;
                          picture path_imagens+'exit24_h.bmp';
                          action pergunta_saida();
                          font 'courier new' size 10;
                          bold;
                		  notabstop
                /*
                ...
                */
				...
				/*
				  dados venda - balcão
				*/
			    @ 080,210 label label_nome_balcao;
     		  			  of form_vender;
                          value 'nome cliente balcão';
                          autosize;
                          font 'courier new' size 12;
                          fontcolor _preto_001;
                          transparent
                @ 100,210 textbox tbox_nome_balcao;
                          of form_vender;
                          height 030;
                          width 200;
                          value '';
				...
				*/
                ...
                @ 045,420 textbox tbox_telefone;
                          ...
                          backcolor _fundo_get;
                          fontcolor _letra_get_1;
                          on enter procura_cliente('form_vender','tbox_telefone')
                ...
                */
			    @ 138,210 label label_pizza;
     		    ...
     		    define comboboxex cbo_tamanhos
			           ...
			           value iif (x_total == 0,1,cbo_tamahos)
         	    ...
         	    */
     		    define comboboxex cbo_composicao_1
			           ...
			           fontsize 10
			           fontcolor BLUE
                       onchange vercomposicao()
         	    end comboboxex
         	    /*
         	      pizza 1
         	    */
                @ 160,265 textbox tbox_pizza_1;
                          of form_vender;
                          height 030;
                          width 050;
                          font 'courier new' size 14;
                          backcolor _fundo_get;
                          fontcolor _letra_get_1;
                          tooltip '<< 00 >> Ir para o Codigo do Produto';
                          on enter procura_pizza(1)
			    @ 160,320 label label_nome_pizza_1;
     		  			  of form_vender;
						  width 240;
						  height 40;
                          value '';
                          ...
                          transparent
		     	/*
                  borda - escolha da borda do cliente
                */
			    @ 140,735 label label_borda;
     		  			  of form_vender;
                          value 'Borda';
                          autosize;
                          font 'courier new' size 12;
     		    ...
     		    define comboboxex cbo_bordas
			           ...
			           fontsize 12
			           fontcolor BLUE
			           on gotfocus verifica_campo_vazio(1)
         	    end comboboxex
                ...
                */
			    @ 140,870 label label_cobertura;
                          ...
                          fontcolor _preto_001;
                          transparent
     		    define comboboxex cbo_coberturas
         	  		   row 160
                       col 870
	              	   width 120
			           height 400
         	    ...
         	    /*
         	      quantidade
         	    */
			    @ 200,900 label label_quantidade;
     		  			  of form_vender;
                          value 'Quantidade';
                          autosize;
                          font 'courier new' size 12;
				...
				/*
				  observações
				*/
			    @ 245,630 label label_observacao;
     		  			  of form_vender;
                          value 'Observações';
                          autosize;
                          font 'courier new' size 12;
                          ...
                          fontcolor _preto_001;
                          transparent
                @ 265,630 textbox tbox_observacao;
                          of form_vender;
                          height 030;
                          width 250;
                          value '';
				...
				*/
                ...
                @ 195,265 textbox tbox_pizza_2;
                          ...
                          backcolor _fundo_get;
                          fontcolor _letra_get_1;
                          on enter procura_pizza(2)
			    @ 195,320 label label_nome_pizza_2;
     		  			  of form_vender;
						  width 220;
						  height 40;
                          value '';
				...
				*/
                ...
                @ 230,265 textbox tbox_pizza_3;
                          ...
                          backcolor _fundo_get;
                          fontcolor _letra_get_1;
                          on enter procura_pizza(3)
			    @ 230,320 label label_nome_pizza_3;
     		  			  of form_vender;
						  width 220;
						  height 40;
                          value '';
                ...
                @ 265,265 textbox tbox_pizza_4;
                          ...
                          backcolor _fundo_get;
                          fontcolor _letra_get_1;
                          on enter procura_pizza(4)

			    @ 265,320 label label_nome_pizza_4;
     		  			  of form_vender;
						  width 220;
						  height 40;
                          value '';
                ...
                * quantidade
			    @ 310,780 label label_quantidade_2;
		  		...
		  		@ 330,780 spinner sp_quantidade_2;
						  ...
						  font 'courier new' size 12;
						  bold;
						  on gotfocus verifica_campo_vazio(2)
                /*
                  botão grava produto
                */
                @ 320,890 buttonex botao_gravar_produto;
                          ...
                          width 120 height 40;
                          picture path_imagens+'img_gravar.bmp';
                          action transfere_produto_pedido(x_tipo_parametro);
                		  font 'courier new' size 12 bold;
                		  backcolor {217,217,255}
				*--------------------------------*
				*                                *
				...
				*--------------------------------*
                ...
                @ 495,890 buttonex botao_cupom;
                          ...
                          action emitir_comanda(_id_venda,x_tipo_parametro);
                		  notabstop;
                		  font 'courier new' size 10 bold
                @ 625,890 buttonex botao_sair;
                          ...
                          action desabilita_botao_voltar();
                		  notabstop;
                		  font 'courier new' size 10 bold

               on key F3 action seleciona_delivery()
               on key f5 action seleciona_balcao()
               on key F4 action seleciona_mesa()
               on key F6 action abrir()
               on key f7 action limpar()
               on key F8 action fecha_pedido()
               on key F9 action pergunta_saida()
			   on key escape action pergunta_saida()
         ...
         return(nil)
*-------------------------------------------------------------------------------
static function pergunta_saida()
	   ...
	   if form_vender.tbox_produto.enabled == .F.
          ...
          desabilita_botao_voltar()
          form_vender.grid_generico.setfocus
          setproperty('form_vender','grid_generico','value',1)
	   endif
...
static function mostra_listagem_produto()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function find_descricao()
...
static function mostra_informacao_produto()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function procura_pizza(p_numero)
       ...
       if found() .and. produtos->pizza
          ...
          elseif p_numero == 4
     	  ...
     	  mostra_listagem_pizza(p_numero)
       endif

*-----------------------------------
       if xcomposicao1 == 2 .and. xcomposicao2 == 1
          form_vender.cbo_composicao_2.setfocus  //   1/2 - 1/2
	   elseif xcomposicao1 == 2 .and.xcomposicao2 == 2  // ir para borda
          form_vender.cbo_bordas.setfocus
	   elseif xcomposicao1 == 2 .and. xcomposicao2 == 1 // 1/2 1/4 1/4
          form_vender.cbo_composicao_2.setfocus
       elseif xcomposicao2 == 4 .and. xcomposicao3 == 1  // 1/2 1/4 1/4
          form_vender.cbo_composicao_3.setfocus
	   elseif xcomposicao3 == 4 .and. xcomposicao4 == 1
          form_vender.cbo_bordas.setfocus // ir para borda.
	   elseif xcomposicao1 == 4 .and.xcomposicao2 == 1   // 1/4 3/4
	      form_vender.cbo_composicao_2.setfocus
	   elseif xcomposicao2 == 6 .and.xcomposicao1 == 4
          form_vender.cbo_bordas.setfocus
       elseif xcomposicao1 == 3 .and. xcomposicao2 == 1  // 1/3 e 2/3
          form_vender.cbo_composicao_2.setfocus
       elseif xcomposicao2 == 5 .and. xcomposicao1 == 3
          form_vender.cbo_bordas.setfocus  // ir para borda
	   elseif xcomposicao3 == 3 .and. xcomposicao4 == 1
          form_vender.cbo_bordas.setfocus  // ir para borda
       endif
       return(nil)
*/
*-------------------------------------------------------------------------------
static function mostra_listagem_pizza(p_numero)
       ...
       define window form_pesquisa;
              ...
              define grid grid_pesquisa
                     ...
                     backcolor WHITE
                     fontcolor BLUE
                     ondblclick mostra_informacao(p_numero)
              end grid
...
static function popula_pizza()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function pesquisar_pizza()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function mostra_informacao(p_numero)
...
static function zera_tabelas()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function cadastrar_novo_produto()
...
static function fecha_pedido()
	   ...
	   local p_parametro := x_tipo_parametro //form_vender.radio_tipo_venda.value
	   ...
	   local x_cobertura          := form_vender.cbo_coberturas.value
	   local x_preco              := 0
	   ...
	   */
       ...
       if found()
          ...
          if x_tipo_venda == 1 //delivery
             ...
             dbselectarea('temp_vendas')
          elseif x_tipo_venda == 2 //balcão
          elseif x_tipo_venda == 3 //mesa
       ...
       */
       define window form_fecha_pedido;
              ...
              */
              @ 460,005 buttonex botao_cupom;
                        ...
                        action imprimir_cupom(v_id,x_valor_pizza,x_valor_prod,form_fecha_pedido.tbox_desconto.value,x_percentual_mesa,x_valor_taxa_entrega,x_ponto_referencia,x_observacoes,v_nome_operacao);
              ...
              @ 460,165 buttonex botao_ok;
                        ...
                        action fechamento_geral(v_id_cliente,v_soma_compra,x_tipo_venda,v_id,p_codigo,y_ncaixa);
       ...
       if x_tipo_venda == 2
		  ...
		  setproperty('form_fecha_pedido','label_003','value','')
...
static function calcula_final(p_borda)
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function fechamento_geral(p_cliente,p_soma,p_tipo,p_id_geral,p_codigo,y_ncaixa)
   	      ...
   	      while .T.
          		...
          		if lock_reg()
    		       replace f_pagam with v_fpagamento
          		   ...
          		   if m_tipovenda == 1 //delivery
          		      replace taxa_deliv with v_taxa
				   endif
          		   if m_tipovenda == 3 //mesas
	   ...
	   *
       x_procura := val(p_codigo)
		  ...
		  elseif p_tipo == 2
          	 dbselectarea('balcao')
          	 balcao->(ordsetfocus('codigo'))
          	 balcao->(dbgotop())
          	 balcao->(dbseek(x_procura))
          	 if found()
             	if lock_reg()
                   balcao->id       := ''
                   balcao->hora     := ''
                   balcao->data     := x_data_limpa
                   balcao->situacao := ''
                   balcao->usuario  := ''
                   balcao->total    := 0
                   balcao->(dbcommit())
...
static function adiciona_montagem()
	   return(nil)
*-------------------------------------------------------------------------------
static function transfere_produto_pedido()

	   local v_tipo      := x_tipo_parametro//form_vender.radio_tipo_venda.value
	   ...
	   local total_geral := 0
       /* dados do cliente */
       local v_nome_balcao  := form_vender.tbox_nome_balcao.value
	   ...
	   *-pegar o numero do caixa.
	   ...
	   replace tipo_venda with v_tipo
  	   replace nome_bal with v_nome_balcao
	   ...
	   *--------------------------*
	   ...
	   elseif v_tipo == 2
	      dbselectarea('balcao')
       	  balcao->(ordsetfocus('id'))
       	  balcao->(dbgotop())
       	  balcao->(dbseek(_id_venda))
       	  if found()
             if lock_reg()
                balcao->total := balcao->total + (x_unitario*p_qtd)
                balcao->(dbunlock())
                balcao->(dbcommit())
             endif
       	  endif
	   ...
	   *--------------------------*
	   ...
	   elseif v_tipo_venda == 2
	      dbselectarea('balcao')
       	  ...
       	  if found()
             if lock_reg()
                balcao->total := balcao->total - v_total
                balcao->(dbunlock())
                balcao->(dbcommit())
             endif
       	  endif
	   	  mostra_info_grid(2)
	   elseif v_tipo_venda == 3
	      dbselectarea('mesas')
       	  mesas->(ordsetfocus('id'))
       	  mesas->(dbgotop())
       	  mesas->(dbseek(_id_venda))
...
static function fecha_montagem_pizza()
	   ...
	   local v_tipo_venda    := x_tipo_parametro //form_vender.radio_tipo_venda.value
       ...
       local v_cobertura     := form_vender.cbo_coberturas.value
	   ...
	   */
	   if val(v_id_pizza_1)+val(v_id_pizza_2)+val(v_id_pizza_3)+val(v_id_pizza_4) == 0
	      ...
	      */
	      if .not. empty(v_id_pizza_1)
			 ...
			 replace nome_bal with iif(v_tipo_venda=2,v_nome_balcao,'')
		  ...
		  */
		  ...
		  v_valor_cobertura := 0
		  v_valor_cobertura := a_valor_cobertura[v_cobertura]
		  if v_valor_cobertura <> 0
 		  	 dbselectarea('temp_vendas')
	   	  	 append blank
		  	 replace id with v_liga_produto
		  	 replace tipo with 1
		  	 replace nome with '=-> COBER.:'+alltrim(a_nome_cobertura[v_cobertura])
		  	 replace subtotal with v_valor_cobertura
		  	 replace id_venda with _id_venda
		  	 replace tipo_venda with v_tipo_venda
		  	 replace nome_bal with iif(v_tipo_venda=2,v_nome_balcao,'')
		  	 replace telefone with iif(v_tipo_venda=1,v_telefone,'')
	   	  ...
	   	  *--------------------------*
	   	  if v_tipo_venda == 1
	      	 dbselectarea('delivery')
       	  	 ...
       	  	 if found()
             	if lock_reg()
                   delivery->total := delivery->total + (x_valor_cobrado*v_qtd_pizza) + v_valor_borda + v_valor_cobertura
                   delivery->(dbunlock())
                   delivery->(dbcommit())
                endif
       	     endif
	      ...
	      elseif v_tipo_venda == 2
	         dbselectarea('balcao')
       	  	 ...
       	  	 if found()
             	if lock_reg()
                   balcao->total := balcao->total + (x_valor_cobrado*v_qtd_pizza) + v_valor_borda + v_valor_cobertura
                   balcao->(dbunlock())
                   balcao->(dbcommit())
                endif
       	     endif
	      ...
	      elseif v_tipo_venda == 3
	         dbselectarea('mesas')
       	  	 ...
       	  	 if found()
             	if lock_reg()
                   mesas->total := mesas->total + (x_valor_cobrado*v_qtd_pizza) + v_valor_borda + v_valor_cobertura
                   mesas->(dbunlock())
                   mesas->(dbcommit())
                endif
       	     endif
	      ...
	      */
	   	  _total_pedido := ( _total_pedido + (x_valor_cobrado*v_qtd_pizza) + v_valor_borda + v_valor_cobertura )
	   	  setproperty('form_vender','label_total','value',trans(_total_pedido,'@E 99,999.99'))
		  /*
		    limpar campos
		  */
       	  setproperty('form_vender','cbo_tamanhos','value')  // estava ,1 para voltar para o tamanho da grande.
       	  ...
       	  setproperty('form_vender','cbo_coberturas','value',1)
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function mostra_venda(p_parametro)
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function imprimir_cupom(p_id,p_vlr_pizza,p_vlr_prod,p_desconto,p_perc_mesa,p_taxa_entrega,p_ponto_ref,p_obs,p_nome_operacao)
...
static function adiciona_borda()
	   return(nil)
*-------------------------------------------------------------------------------
static function adiciona_cobertura()
	   return(nil)
*----------------------------------------------------------------------
static function emitir_comanda(p_parametro)

       local x_nome, x_fixo, x_endereco, x_numero
	   local x_tipo_venda       := x_tipo_parametro//form_vender.radio_tipo_venda.value
	   local x_nome_balcao      := form_vender.tbox_nome_balcao.value
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function seleciona_tipo_de_venda()
	   ...
	   if v_tipo == 1
	      ...
	      setproperty('form_vender','label_cabecalho','fontcolor',{0,225,0})
*       	  setproperty('form_vender','radio_tipo_venda','enabled',.F.)
       	  mostra_info_grid(1)
	   ...
	   elseif v_tipo == 2
	      setproperty('form_vender','label_cabecalho','value','BALCÃO')
	      setproperty('form_vender','label_cabecalho','fontcolor',{140,198,255})
*       	  setproperty('form_vender','radio_tipo_venda','enabled',.F.)
       	  mostra_info_grid(2)
       	  setproperty('form_vender','grid_generico','enabled',.T.)
       	  setproperty('form_vender','botao_abre','enabled',.T.)
...
static function habilita_campos_delivery()
       ...
       setproperty('form_vender','label_cobertura','enabled',.T.)
       setproperty('form_vender','cbo_coberturas','enabled',.T.)
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function habilita_campos_balcao()
       ...
       setproperty('form_vender','botao_cadastra_produto','enabled',.T.)
       setproperty('form_vender','botao_cadastra_cliente','enabled',.T.)
       setproperty('form_vender','label_nome_balcao','enabled',.T.)
       setproperty('form_vender','tbox_nome_balcao','enabled',.T.)
       setproperty('form_vender','label_pizza','enabled',.T.)
	   setproperty('form_vender','cbo_tamanhos','enabled',.T.)
       setproperty('form_vender','label_pizza_2','enabled',.T.)
       setproperty('form_vender','cbo_composicao_1','enabled',.T.)
	   ...
	   form_vender.tbox_nome_balcao.setfocus
...
static function habilita_campos_mesa()
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function mostra_info_grid(p_parametro)
	   ...
	   */
	   ...
	   elseif p_parametro == 2
       	  dbselectarea('balcao')
       	  balcao->(ordsetfocus('codigo'))
       	  balcao->(dbgotop())
       	  while .not. eof()
             	add item {alltrim(str(balcao->codigo)),alltrim(balcao->id),alltrim(balcao->nome),substr(balcao->hora,1,5),trans(balcao->total,'@E 999,999.99')} to grid_generico of form_vender
             	balcao->(dbskip())
          end
	   elseif p_parametro == 3
       	  dbselectarea('mesas')
       	  mesas->(ordsetfocus('codigo'))
       	  mesas->(dbgotop())
       	  while .not. eof()
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function desabilita_campos()
       ...
       setproperty('form_vender','label_nome_balcao','enabled',.F.)
          setproperty('form_vender','label_telefone','enabled',.F.)
          setproperty('form_vender','tbox_telefone','enabled',.F.)
          setproperty('form_vender','label_telefone','enabled',.F.)
          setproperty('form_vender','tbox_telefone','enabled',.F.)
       setproperty('form_vender','tbox_nome_balcao','enabled',.F.)
      ...
      setproperty('form_vender','label_cobertura','enabled',.F.)
      setproperty('form_vender','cbo_coberturas','enabled',.F.)
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function habilita_campos()
...
*       setproperty('form_vender','grid_generico','enabled',.T.)
       ...
       setproperty('form_vender','botao_cupom','enabled',.T.)
       setproperty('form_vender','botao_sair','enabled',.T.)
*       setproperty('form_vender','grd_generico','enabled',.T.)
...
*       endif
	   ...
	   mostra_info_grid(p_parametro)
	   
	   desabilita_botoes(p_parametro)
	   
       return(nil)
*-------------------------------------------------------------------------------
static function consumir()
	   ...
	   */
	   ...
	   temp_vendas->(dbseek(_id_venda))
	   if found()
       	  setproperty('form_vender','tbox_nome_balcao','value',alltrim(temp_vendas->nome_bal))
...
*	   return(nil)
**-------------------------------------------------------------------------------
static function desabilita_botao_voltar()
	   ...
	   return(nil)
*-------------------------------------------------------------------------------
static function limpa_campos()

       setproperty('form_vender','tbox_nome_balcao','value','')
*       setproperty('form_vender','label_telefone','value','')
...
*       endif
       ...
       return(nil)
*-------------------------------------------------------------------------------
static function verifica_campo_vazio(p_parametro)
...
static function desabilita_botoes(p_parametro)

	   limpa_campos()


       setproperty('form_vender','botao_delivery','enabled',.F.)
       setproperty('form_vender','botao_balcao','enabled',.F.)
       setproperty('form_vender','botao_mesa','enabled',.F.)
...
static function habilita_botoes(p_parametro)

	   limpa_campos()


       setproperty('form_vender','botao_delivery','enabled',.T.)
       setproperty('form_vender','botao_balcao','enabled',.T.)
       setproperty('form_vender','botao_mesa','enabled',.T.)
       setproperty('form_vender','grid_generico','enabled',.T.)
       setproperty('form_vender','botao_abre','enabled',.T.)
       setproperty('form_vender','botao_consumo','enabled',.T.)
       setproperty('form_vender','botao_fecha','enabled',.T.)
...
static function seleciona_delivery()

	   x_tipo_parametro := 1
	   public x_tipo_parametro
       seleciona_tipo_de_venda(x_tipo_parametro)

static function seleciona_balcao()

       x_tipo_parametro := 2
       public x_tipo_parametro
       seleciona_tipo_de_venda(x_tipo_parametro)

static function seleciona_mesa()

       x_tipo_parametro := 3
       form_vender :=x_tipo_parametro
       public x_tipo_parametro

       seleciona_tipo_de_venda(x_tipo_parametro)

static function vercomposicao()


	  xcomposicao1 := form_vender.cbo_composicao_1.value
      xcomposicao2 := form_vender.cbo_composicao_2.value
      xcomposicao3 := form_vender.cbo_composicao_3.value
      xcomposicao4 := form_vender.cbo_composicao_4.value

/*
	  msginfo(xcomposicao1,'composicao 1')
	  msginfo(xcomposicao2,'composicao 2')
	  msginfo(xcomposicao3,'composicao 3')
	  msginfo(xcomposicao4,'composicao 4')
*/
